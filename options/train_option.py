...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--max_epoch', type=int, default=150, help='Maximum number of epoch for training')
        ...
        self.parser.add_argument('--milestones', default=[150_000], nargs="+", type=int,
        ...
        self.parser.add_argument('--save_latest', type=int, default=10000,
